    ...
    <>
      <section className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-24 mb-16 text-black">
        ...
        <div className="space-y-6">
          {/* // v-if="visibleExperiences.length === 0" key="empty-state" */}
          <div>
          ...
          <div className="relative border border-gray-200 p-8 transition-all group overflow-hidden">
            ...
            <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
              {/* <BtnExperiences :modalRef="modalRef" :experience="exp" :experiences="expData" /> */}
            </div>
          </div>
          {/* v-if="isExpanded && user?.role === 'admin' && isAuthenticated" */}
          <div key="add-button">
